...
public class LocalSearchFragment$$ViewBinder<T extends com.tama.chat.ui.fragments.search.LocalSearchFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755497, "field 'dialogsRecyclerView' and method 'touchList'");
    target.dialogsRecyclerView = finder.castView(view, 2131755497, "field 'dialogsRecyclerView'");
