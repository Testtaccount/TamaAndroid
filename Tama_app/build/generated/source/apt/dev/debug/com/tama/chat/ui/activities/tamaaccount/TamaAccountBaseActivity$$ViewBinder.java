...
public class TamaAccountBaseActivity$$ViewBinder<T extends com.tama.chat.ui.activities.tamaaccount.TamaAccountBaseActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755751, "field 'shoppingButton' and method 'onClickOnShoppingCart'");
    target.shoppingButton = finder.castView(view, 2131755751, "field 'shoppingButton'");
    ...
    view = finder.findRequiredView(source, 2131755752, "field 'productCount'");
    target.productCount = finder.castView(view, 2131755752, "field 'productCount'");
  }
