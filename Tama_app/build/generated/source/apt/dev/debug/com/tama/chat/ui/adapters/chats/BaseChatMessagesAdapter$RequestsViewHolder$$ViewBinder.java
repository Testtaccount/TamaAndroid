...
public class BaseChatMessagesAdapter$RequestsViewHolder$$ViewBinder<T extends com.tama.chat.ui.adapters.chats.BaseChatMessagesAdapter.RequestsViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    target.messageTextView = finder.castView(view, 2131755631, "field 'messageTextView'");
    view = finder.findOptionalView(source, 2131755630, null);
    target.timeTextMessageTextView = finder.castView(view, 2131755630, "field 'timeTextMessageTextView'");
    view = finder.findOptionalView(source, 2131755634, null);
    target.acceptFriendImageView = finder.castView(view, 2131755634, "field 'acceptFriendImageView'");
    ...
    target.rejectFriendImageView = finder.castView(view, 2131755632, "field 'rejectFriendImageView'");
  }
