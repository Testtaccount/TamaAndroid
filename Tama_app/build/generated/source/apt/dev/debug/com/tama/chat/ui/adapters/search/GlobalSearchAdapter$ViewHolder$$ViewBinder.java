...
public class GlobalSearchAdapter$ViewHolder$$ViewBinder<T extends com.tama.chat.ui.adapters.search.GlobalSearchAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755615, "field 'statusTextView'");
    target.statusTextView = finder.castView(view, 2131755615, "field 'statusTextView'");
    view = finder.findRequiredView(source, 2131755614, "field 'addFriendImageView'");
    target.addFriendImageView = finder.castView(view, 2131755614, "field 'addFriendImageView'");
  }
