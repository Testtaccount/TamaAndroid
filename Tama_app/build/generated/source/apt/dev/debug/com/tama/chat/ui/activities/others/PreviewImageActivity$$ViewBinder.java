...
public class PreviewImageActivity$$ViewBinder<T extends com.tama.chat.ui.activities.others.PreviewImageActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755335, "field 'imageTouchImageView'");
    target.imageTouchImageView = finder.castView(view, 2131755335, "field 'imageTouchImageView'");
  }
