...
public class MyTamaMobileTopUpRequestActivity$$ViewBinder<T extends com.tama.chat.ui.activities.tamaaccount.MyTamaMobileTopUpRequestActivity> extends com.tama.chat.countryCode.BaseMultiFlagActivity$$ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755306, "field 'phoneErrorTextFirst'");
    target.phoneErrorTextFirst = finder.castView(view, 2131755306, "field 'phoneErrorTextFirst'");
    view = finder.findRequiredView(source, 2131755312, "field 'phoneErrorTextSecond'");
    target.phoneErrorTextSecond = finder.castView(view, 2131755312, "field 'phoneErrorTextSecond'");
