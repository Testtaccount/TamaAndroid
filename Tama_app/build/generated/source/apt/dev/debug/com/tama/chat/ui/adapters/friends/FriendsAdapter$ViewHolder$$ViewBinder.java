...
public class FriendsAdapter$ViewHolder$$ViewBinder<T extends com.tama.chat.ui.adapters.friends.FriendsAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755628, "field 'firstLatterTextView'");
    target.firstLatterTextView = finder.castView(view, 2131755628, "field 'firstLatterTextView'");
    ...
    view = finder.findRequiredView(source, 2131755629, "field 'labelTextView'");
    target.labelTextView = finder.castView(view, 2131755629, "field 'labelTextView'");
  }
