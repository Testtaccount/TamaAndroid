...
public class TopupMyAccountActivity$$ViewBinder<T extends com.tama.chat.ui.activities.tamaaccount.TopupMyAccountActivity> extends com.tama.chat.ui.activities.tamaaccount.TamaAccountBaseActivity$$ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    View view;
    view = finder.findRequiredView(source, 2131755357, "field 'topupVoucherText'");
    target.topupVoucherText = finder.castView(view, 2131755357, "field 'topupVoucherText'");
    ...
    view = finder.findRequiredView(source, 2131755358, "field 'topupButton' and method 'sendTopupRequest'");
    target.topupButton = finder.castView(view, 2131755358, "field 'topupButton'");
