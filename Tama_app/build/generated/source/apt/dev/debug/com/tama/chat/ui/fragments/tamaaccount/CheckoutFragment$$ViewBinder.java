...
public class CheckoutFragment$$ViewBinder<T extends com.tama.chat.ui.fragments.tamaaccount.CheckoutFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755458, "field 'btnConfirm' and method 'OnClickConfirmBtn'");
    target.btnConfirm = finder.castView(view, 2131755458, "field 'btnConfirm'");
    ...
    view = finder.findRequiredView(source, 2131755459, "field 'btnRequestOrder' and method 'OnClickRequestOrder'");
    target.btnRequestOrder = finder.castView(view, 2131755459, "field 'btnRequestOrder'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
