...
public class PayTamaExpressRequestActivity$$ViewBinder<T extends com.tama.chat.ui.activities.tamaaccount.PayTamaExpressRequestActivity> extends com.tama.chat.countryCode.BaseFlagActivity$$ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755333, "field 'tamaExpressText'");
    target.tamaExpressText = finder.castView(view, 2131755333, "field 'tamaExpressText'");
    ...
    view = finder.findRequiredView(source, 2131755334, "field 'tamaExpressErrorText'");
    target.tamaExpressErrorText = finder.castView(view, 2131755334, "field 'tamaExpressErrorText'");
