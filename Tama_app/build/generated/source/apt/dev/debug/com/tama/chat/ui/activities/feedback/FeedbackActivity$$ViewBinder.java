...
public class FeedbackActivity$$ViewBinder<T extends com.tama.chat.ui.activities.feedback.FeedbackActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755235, "field 'feedbackTypesRadioGroup'");
    target.feedbackTypesRadioGroup = finder.castView(view, 2131755235, "field 'feedbackTypesRadioGroup'");
  }
