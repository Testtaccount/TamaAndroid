...
public class TamaAboutUsActivity extends BaseActivity implements View.OnClickListener,
    SwipeRefreshLayout.OnRefreshListener {

  private static final String LOG_TAG = TamaAboutUsActivity.class.getSimpleName();
  ...
  protected int getContentResId() {
    return R.layout.activity_tama_about_us;
  }
