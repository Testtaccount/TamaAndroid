...
public class ContactUsActivity extends TamaAccountBaseActivity implements
...
//    String message = jsonData.getString("message");
    ...
    if (jsonData != null) {
      JSONObject jsonObjectResult = jsonData.getJSONObject("result");
      JSONObject jsonObjectPhone = jsonObjectResult.getJSONObject("phone");
      JSONArray jsonArrayMail = jsonObjectResult.getJSONArray("email");
