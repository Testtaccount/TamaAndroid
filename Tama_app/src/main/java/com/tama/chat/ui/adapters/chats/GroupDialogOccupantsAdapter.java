...
import com.tama.chat.ui.adapters.base.BaseListAdapter;
...
public class GroupDialogOccupantsAdapter extends BaseListAdapter<QMUser> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.addFriendImageView.setVisibility(View.GONE);//.setVisibility(isFriend(user) ? View.GONE : View.VISIBLE);
