...
import com.tama.chat.utils.broadcasts.NetworkChangeReceiver;
import com.tama.chat.utils.helpers.ActivityUIHelper;
import com.tama.chat.utils.helpers.LoginHelper;
import com.tama.chat.utils.helpers.SharedHelper;
import com.tama.chat.utils.helpers.notification.NotificationManagerHelper;
...
// finally change the color
    ...
    public void setTamaCustomActionBarIcon(Drawable icon, ImageView v) {
        if (v != null) {
            // In appcompat v21 there will be no icon if we don't add this display option
...
//            QBChatDialog dialog = DataManager.getInstance().getQBChatDialogDataManager().getByDialogId(appSharedHelper.getPushDialogId());
...
//    }
    ...
    private void addActions() {
        ...
        addAction(QBServiceConsts.LOGIN_CHAT_COMPOSITE_FAIL_ACTION, new LoginChatCompositeSuccessAction());//, new LoginChatCompositeFailAction());
...
//    }
    ...
    protected void startActivityByName (Class<?> activityName, boolean needClearTask,int page){
