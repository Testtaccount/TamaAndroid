...
import com.tama.chat.ui.adapters.chats.PrivateChatMessageAdapter;
...
import com.tama.q_municate_db.managers.FriendDataManager;
...
//    protected WrapContentLinearLayoutManager wrapContentLinearLayoutManager;
...
//
//        try {
//            privateChatHelper.sendPrivateMessageWithAttachImage(file, opponentUser.getId(), isSnapChat, loadSnapTime());
...
//        deleteMessageID = (String) view.getTag();
//    }
//
//    @Override
...
//        QBDeleteChatCommand.start(this, null, null, id);
////        DbUtils.deleteMessageLocal(dataManager, id);
//    }
...
//Avetik        boolean isFriend = DataManager.getInstance().getFriendDataManager().getByUserId(opponentUser.getUserId()) != null;
        boolean isFriend = true;//Avetik
...
//            return;
//        }
//        List<DialogOccupant>dialogOccupants = createDialogOccupantList();
//        List<QBUser> qbUserList = new ArrayList<>(3);
...
//    }
    ...
    private void callToUser(QMUser user, QBRTCTypes.QBConferenceType qbConferenceType) {
        ...
        qmUserList.add(user);
        CallActivity.start(PrivateDialogActivity.this, qbUserList, qbConferenceType, null,
            currentChatDialog.getType(), qmUserList);
    }
