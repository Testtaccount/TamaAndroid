...
import com.tama.q_municate_core.core.concurrency.BaseErrorAsyncTask;
...
//        try {
            subscriptions = (ArrayList<QBSubscription>) QBPushNotifications.createSubscription(subscription);
