...
public abstract class BaseFlagActivity extends TamaAccountBaseActivity {
    ...
    protected CustomPhoneNumberFormattingTextWatcher textWatcher;
    protected boolean editNumber = false;
    ...
    protected void initUI() {
        ...
        textWatcher = new CustomPhoneNumberFormattingTextWatcher(mOnPhoneChangedListener);
        enterPhoneNumberText.addTextChangedListener(textWatcher);
        ...
        enterPhoneNumberText.setFilters(new InputFilter[]{filter});
        enterPhoneNumberText.setImeOptions(EditorInfo.IME_ACTION_SEND);
        enterPhoneNumberText.setImeActionLabel(getString(R.string.label_send), EditorInfo.IME_ACTION_SEND);
    }
...
//    }
    ...
    {
        BALANCE,PHONE_NUMBER,TRANSFER,SEND_REQUEST
    }
