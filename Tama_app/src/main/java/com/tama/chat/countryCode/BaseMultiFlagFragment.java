...
public class BaseMultiFlagFragment extends Fragment {
    ...
    protected AdapterView.OnItemSelectedListener getOnItemSelectedListener(final Spinner spinner,final EditText editPhoneText){
...
//    protected OnPhoneChangedListener mOnPhoneChangedListenerFirst = new OnPhoneChangedListener() {
//        @Override
//        public void onPhoneChanged(String phone) {
//            try {
//                mLastEnteredPhone = phone;
...
//                if (country != null) {
//                    final int position = country.getNum();
//                    countryCodeSpinner.post(new Runnable() {
//                        @Override
//                        public void run() {
...
//    };
    ...
    protected void initUI() {
        countryCodeSpinnerFirst.setOnItemSelectedListener(getOnItemSelectedListener(countryCodeSpinnerFirst,enterPhoneNumberTextFirst));
        countryCodeSpinnerSecond.setOnItemSelectedListener(getOnItemSelectedListener(countryCodeSpinnerSecond,enterPhoneNumberTextSecond));

        mAdapter = new CountryAdapter(getActivity());

        countryCodeSpinnerFirst.setAdapter(mAdapter);
        countryCodeSpinnerSecond.setAdapter(mAdapter);

        enterPhoneNumberTextFirst.addTextChangedListener(new CustomPhoneNumberFormattingTextWatcher(getOnPhoneChangedListener(countryCodeSpinnerFirst)));
        enterPhoneNumberTextSecond.addTextChangedListener(new CustomPhoneNumberFormattingTextWatcher(getOnPhoneChangedListener(countryCodeSpinnerSecond)));
    ...
    protected void initCodes() {
        new AsyncPhoneInitTask(getActivity(),countryCodeSpinnerFirst).execute();
        new AsyncPhoneInitTask(getActivity(),countryCodeSpinnerSecond).execute();
    }
    ...
    protected class AsyncPhoneInitTask extends AsyncTask<Void, Void, ArrayList<Country>> {
        ...
        public AsyncPhoneInitTask(Context context,Spinner spinner) {
            mContext = context;
