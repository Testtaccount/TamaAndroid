...
import com.tama.chat.ui.fragments.dialogs.base.OneButtonDialogFragment;
...
public class ValidationUtils {
    ...
    public boolean isFirstNameValid(TextInputLayout firstNameTextInputLayout, String newFirstName) {
        boolean fullNameEntered = !TextUtils.isEmpty(newFirstName.trim());
        boolean valid = true;

        if (fullNameEntered) {
            if (newFirstName.length() < FULL_NAME_MIN_LENGTH) {
                valid = false;
                firstNameTextInputLayout.setError(context.getString(R.string.auth_first_name_field_is_too_short));
            } else if (newFirstName.length() > FULL_NAME_MAX_LENGTH) {
                valid = false;
                firstNameTextInputLayout.setError(context.getString(R.string.auth_first_name_field_is_too_long));
            }
        } else {
            valid = false;
            firstNameTextInputLayout.setError(context.getString(R.string.profile_first_name_not_entered));
        }
    ...
    public boolean isLastNameValid(TextInputLayout lastNameTextInputLayout, String newLastName) {
        boolean fullNameEntered = !TextUtils.isEmpty(newLastName.trim());
        boolean valid = true;

        if (fullNameEntered) {
            if (newLastName.length() < FULL_NAME_MIN_LENGTH) {
                valid = false;
                lastNameTextInputLayout.setError(context.getString(R.string.auth_last_name_field_is_too_short));
            } else if (newLastName.length() > FULL_NAME_MAX_LENGTH) {
                valid = false;
                lastNameTextInputLayout.setError(context.getString(R.string.auth_last_name_field_is_too_long));
            }
        } else {
            valid = false;
            lastNameTextInputLayout.setError(context.getString(R.string.profile_last_name_not_entered));
        }
