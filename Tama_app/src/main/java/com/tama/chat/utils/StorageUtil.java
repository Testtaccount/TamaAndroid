...
//    public static String getAppExternalDataDirectoryPathForPhoto() {
//        StringBuilder sb = new StringBuilder();
//        sb.append(Environment.getExternalStorageDirectory()).append(File.separator).append("Tama").append(File.separator);
//        return sb.toString();
//    }
...
//    public static File getAppExternalDataDirectoryFileFromPhoto() {
//        File dataDirectoryFile = new File(getAppExternalDataDirectoryPathForPhoto());
//        dataDirectoryFile.mkdirs();
//
//        return dataDirectoryFile;
//    }
