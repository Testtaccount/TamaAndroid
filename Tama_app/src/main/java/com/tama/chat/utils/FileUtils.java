...
public class FileUtils {
    ...
    private static final String folderName = "/Tama";
    private static final String fileType = ".jpg";
    private static final String TAD = "myLogs";
...
//        String fileName = "Tama_Camera_" + String.valueOf(System.currentTimeMillis()) + fileType;
    ...
    private class SavingFileTask extends AsyncTask<Object, String, Object> {
        ...
        protected Object doInBackground(Object... objects) {
            ...
            try {
                ...
                bitmap.compress(Bitmap.CompressFormat.PNG, ConstsCore.ZERO_INT_VALUE, byteArrayOutputStream);//NAEL
//                bitmap.compress(Bitmap.CompressFormat.JPEG, 100, byteArrayOutputStream);//NAEL
