...
//    chatDestroyed = chatDestroyed && !isLoggedIn();
//    Log.d(TAG,
//        "onActivityStarted , chatDestroyed=" + chatDestroyed + ", numberOfActivitiesInForeground= "
//            + numberOfActivitiesInForeground);
...
//  @SuppressLint("LongLogTag")
//  public void onActivityResumed(Activity activity) {
//    Log.d("ActivityLifecycleHandler",
//        "onActivityResumed " + activity.getClass().getSimpleName() + " count of activities = "
//            + numberOfActivitiesInForeground);
//  }
//
//  public boolean isActivityLogeable(Activity activity) {
