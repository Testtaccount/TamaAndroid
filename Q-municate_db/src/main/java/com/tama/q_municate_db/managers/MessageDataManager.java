...
public class MessageDataManager extends BaseManager<Message> {
    ...
    public MessageDataManager(Dao<Message, Long> messageDao, Dao<Dialog, Long> dialogDao,Dao<DialogOccupant, Long> dialogOccupantDao) {
    ...
    public void deleteById(String messageId) {
        try {
            DeleteBuilder<Message, Long> deleteBuilder = dao.deleteBuilder();
            deleteBuilder.where().eq(Message.Column.ID, messageId);

//            Where<Message, Long> where = deleteBuilder.where();
//            where.and(
//                where.in(Message.Column.ID, Integer.valueOf(messageId)),
//                where.or(
//                    where.eq(Message.Column.STATE, State.TEMP_LOCAL),
//                    where.eq(Message.Column.STATE, State.TEMP_LOCAL_UNREAD)
//                )
//            );
        ...
        notifyObserversDeletedById(messageId);
//        notifyObserversDeletedById(messageId);
//        notifyObservers();
    }
