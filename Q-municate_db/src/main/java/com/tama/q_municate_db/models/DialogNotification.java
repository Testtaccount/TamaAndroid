...
import static com.tama.q_municate_db.models.DialogNotification.Column.BODY;
import static com.tama.q_municate_db.models.DialogNotification.Column.CREATED_DATE;
import static com.tama.q_municate_db.models.DialogNotification.Column.ID;
import static com.tama.q_municate_db.models.DialogNotification.Column.STATE;
import static com.tama.q_municate_db.models.DialogNotification.Column.TABLE_NAME;
import static com.tama.q_municate_db.models.DialogNotification.Column.TYPE;
...
public class DialogNotification implements Serializable {
  ...
  @DatabaseField(
      ...
      canBeNull = false,
      columnDefinition = "INTEGER REFERENCES " + DialogOccupant.Column.TABLE_NAME + "("
          + DialogOccupant.Column.ID + ") ON DELETE CASCADE",
