...
public class CombinationMessage extends QBChatMessage implements Serializable {
    ...
    public CombinationMessage(Message message) {
        ...
        this.snapMessage = message.getSnapMessage();
        this.snapMessageTime = message.getSnapMessageTime();
        this.isSnapInProgress = message.getIsSnapInProgress();
    ...
    public Message toMessage() {
        ...
        message.setSnapMessage(snapMessage);
        message.setSnapMessageTime(snapMessageTime);
        message.setIsSnapInProgress(isSnapInProgress);
//        message.setTimerTask(timerTask);
        return message;
    }
    ...
    public void setSnapMessageTime(int time){
...
//    public void setAsyncTask(TimerAsyncTask timerTask){
//        this.timerTask = timerTask;
//    }
//
//    public TimerAsyncTask getAsyncTask(){
//        return timerTask;
//    }

    public void setIsSnapInProgress(Boolean bool){
        this.isSnapInProgress = bool;
    }
    ...
    public String toString(){
        ...
        sb.append("[ messageId = " + getMessageId())
                ...
                .append(", body = " + getBody())
                .append(", snapMessage = " + getSnapMessage())
                .append(", snapMessageTime = " + getSnapMessageTime())
