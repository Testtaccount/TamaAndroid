...
//        lastMessage = ChatUtils.getDialogLastMessage(context.getResources().getString(R.string.cht_notification_message), message, dialogNotification);
        ...
        lastMessage = ChatUtils.getDialogLastMessage(context.getResources().getString(R.string.cht_notification_message),context.getResources().getString(R.string.snap_text), message, dialogNotification);
    }
