...
import com.tama.q_municate_core.models.ChatNotificationType;
...
public class ChatNotificationUtils {
    ...
    public static final String SNAP_CHAT_MESSAGE_KEY = "snapMessage";
    public static final String SNAP_CHAT_MESSAGE_VALUE = "YES";
    public static final String SNAP_CHAT_MESSAGE_TIME = "snapMessageTime";
